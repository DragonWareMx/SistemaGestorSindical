...
const secretariaInterior = ({conflicts}) => {
    ...
    const columns = [
      ...
      },
      {
        ...
        flex: 0.2,
        renderCell: (params) => (
          <InertiaLink href={route('secretariaInterior.conflict', params.row.uuid)} style={{textDecoration: 'none', color: 'gray'}}><VisibilityIcon/></InertiaLink>
        ),
        sortable: false,
        editable: false,
      }
