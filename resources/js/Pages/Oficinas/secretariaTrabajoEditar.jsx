                        ...
                        <div className="card-content">
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="row div-form-register" style={{ "padding": "3%" }}>
                                    <div className="col s12 m12 div-division">
                                        ...
                                        <div className="input-field col s12" style={{ marginTop: '15px' }}>
                                            <input id="num_oficio" type="text" disabled className={errors.num_oficio ? "validate form-control invalid" : "validate form-control"} name="num_oficio" value={values.num_oficio} required onChange={handleChange} readOnly onFocus={(e) => { e.target.removeAttribute("readonly") }} required />
                                        ...
                                        <div class="input-field col s12" style={{ marginTop: '15px' }}>
                                            <textarea id="textarea1" class="materialize-textarea" onChange={handleChangeTextarea} disabled={values.editar} value={values.observaciones}></textarea>
                                                ...
                                                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                                                    ...
                                                    <TableBody>
                                                        {emploInfo.empleados.map((trabajador, index) => (
                                                            ...
                                                            >
                                                                <TableCell scope="row">
                                                                    <IconButton aria-label="delete" color="error" disabled={values.editar} onClick={() => (removeEmpleado(index))}>
                                                                        <DeleteIcon />
                                                                    </IconButton>
                                                                </TableCell>
                                ...
                                <div className="row container-buttons" style={{ display: 'none' }} id="btns-form">
                                    ...
                                    {(() => {
                                        if (auth.user.roles['0'].slug == 'admin' || auth.user.roles['0'].name == 'secGen' || auth.user.roles['0'].name == 'respST') {
                                            return <Eliminar oficina={'Secretaría del Trabajo'} ruta={'secretariaTrabajo.delete'} id={conflict.uuid} />
                                        }
                                    })()}
...
Edit.layout = page => <Layout children={page} title="Escuela Sindical - Secretaría del Trabajo" pageTitle="Secretaría del Trabajo" />
