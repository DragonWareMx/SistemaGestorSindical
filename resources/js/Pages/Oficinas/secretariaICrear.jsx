...
secretariaICrear.layout = page => <Layout children={page} title="Escuela Sindical - Secretaria del Interior" pageTitle="SECRETARIA DEL INTERIOR" />

export default secretariaICrear
