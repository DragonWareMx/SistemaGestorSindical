...
Route::delete('/honor-y-justicia/delete/{uuid}', [App\Http\Controllers\IssueController::class, 'destroy'])->name('honor.delete');
//Conflictos
...
Route::delete('/conflictos/delete/{uuid}', [App\Http\Controllers\ConflictController::class, 'destroy'])->name('conflicts.delete');
...
Route::delete('/secretaria-del-trabajo/delete/{uuid}', [App\Http\Controllers\ConflictController::class, 'destroy'])->name('secretariaTrabajo.delete');
...
Route::delete('/secretaria-del-interior/delete/{uuid}', [App\Http\Controllers\ElectionController::class, 'destroy'])->name('secretariaInterior.delete');
...
Route::delete('/admision-y-cambios/delete', [App\Http\Controllers\EmployeeController::class, 'admisionCambiosDestroy'])->name('admisionCambiosDestroy');
...
Route::post('/accion-femenil/delete', [App\Http\Controllers\TrophyController::class, 'destroy'])->name('accionFemenil.destroy');
